...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>ECE Tech News - A new record broken by the SpaceX rocket</title>
    ...
    <body class="antialiased">
        ...
        <div class="pt-4 grid grid-rows-1 sm:grid-rows-1 sm:grid-cols-6 items-center">
            ...
            <div class="p-4 col-span-6 sm:col-span-4">
                <div class="text-2xl text-red-600 font-serif">A new record broken by the SpaceX rocket :</div>
                <div class="italic">Reading time : 1m</div>
                <div class="mt-8 tracking-wider">For its last mission, the rocket Falcon 9 B1051 made its ninth flight, which is a record. However it remains without surprise for Elon Musk who estimated the average life of 10 flights for Falcon 9 launchers. The most interesting thing is the mission.</div>
                <div class="mt-4 grid grid-cols-8 gap-2">
                    <div class="col-span-5 tracking-wider">
                        This one consisted in propelling 60 satellites in low orbit. These satellites are used to feed the network of the Starlink constellation. This network is currently made up of more than 1,000 satellites. SpaceX has the authorization to send 12,000 but Elon Musk intends to send much more. Thanks to these satellites SpaceX intends to provide the whole planet, even the most isolated regions, with a high-speed Internet network. But this is not the only achievement of the month for Elon Musk's space company, because if the Falcons 9 manage to land over and over it is not the case for all their launchers. The Starship SN8 and SN9 rockets had failed the landing tests.   
                    </div>
                    <div class="col-span-3 bg-cover bg-hero-spacex rounded"></div>
                </div>       
                <div class="mt-4 tracking-wider">
                    However SN10 succeeded, it nevertheless exploded a few minutes later due to causes still unknown to this day. This is still an achievement for the rockets destined to populate Mars. So SpaceX and their fans were more than satisfied.
                </div>
