...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>ECE Tech News - How Alan Turing contributed to computer science</title>
    ...
    <body class="antialiased">
        ...
        <div class="pt-4 grid grid-rows-1 sm:grid-rows-1 sm:grid-cols-6 items-center">
            ...
            <div class="p-4 col-span-6 sm:col-span-4">
                <div class="text-2xl text-red-600 font-serif">How Alan Turing contributed to computer science </div>
                <div class="italic">Reading time : 2m</div>
                <div class="mt-8 tracking-wider">Alan Turing is a British man born in 1912.   He is the author of many works about mathematics and exploits during the WWII. However, most of his creations were silenced for a long time. We will see how it impacted the world, whether real or virtual.</div>
                <div class="mt-4 tracking-wider">
                    From his early childhood, Alan developed a taste for numbers and puzzles. He learns to read in three weeks. Only at 16, he understands why Einstein's works question the rules of celestial mechanics and Euclid's proposition. In order to solve math’s problems during university he implements this abstract notion of <span class="italic">Turing's machine</span> allowing to set up algorithms. He also implements the notion of programming.
                </div>
                <div class="mt-4 grid grid-cols-8 gap-2">
                    <div class="col-span-5">
                        <div class="tracking-wider">
                            A Major part of his work was about cryptanalysis. He participated in deciphering coded messages with the Enigma machine used by the German forces during WW2. He and his team enabled the allies to intercept and understand land and even naval communications. Some historians describe that his work would have saved two years from the length of the war.
                        </div>
                        <div class="mt-4 tracking-wider">
                    ...
                    <div class="col-span-3 bg-cover bg-hero-aturing rounded"></div>
                </div>
                
                
                <div class="mt-4 tracking-wider">
                    Alan Turing did countless works in the field of science. Unfortunately, his participation in the war was classified until his death and he never knew the fame he has now. He was also convicted of homosexuality and died of poisoning at only 41 years old leaving behind great advancements in science.
                </div>
